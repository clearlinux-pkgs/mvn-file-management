...
License  : Apache-2.0
Requires: mvn-file-management-data = %{version}-%{release}

%description
No detailed description available

%package data
Summary: data components for the mvn-file-management package.
Group: Data

%description data
data components for the mvn-file-management package.
